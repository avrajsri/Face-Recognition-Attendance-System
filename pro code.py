...
message = Label(root, text="", fg="#0055ff", bg="white", bd=4, relief=GROOVE, activebackground="yellow", width=35,
                height=2, font=('times', 15, ' bold '))
message.configure(text="Welcome to Recognising System")
...
listNodes = Listbox(frame, width=42, height=4, bd=4, font=('times', 15, ' bold '), selectbackground="blue",
                    activestyle="none")
...
lbl5 = Label(root, text=show, width=41, fg="#0055ff", bg="white", height=0, font=('times', 13, ' bold'))
lbl5.place(x=230, y=425)
...
def TakeImages():
    ...
    if (len(Id) == 0 & len(name) == 0):
        ...
        res = "And Enter Alphabetical Name"
        message.configure(text=res)
        talkToMe(res)
...
def TrainImages():
    try:
        ...
        talkToMe("Image Trained")

    except Exception as e:
        message.configure(text="First Add Students")
        talkToMe("First Add Students")
...
def TrackImages():
    try:
        ...
        message.configure(text="First Train Images")
...
trainImg = Button(root, text="Train Images", command=TrainImages, bg="#3eff00", activebackground="#0055ff",
                  activeforeground="white", bd=4, font=('times', 15, ' bold '))
